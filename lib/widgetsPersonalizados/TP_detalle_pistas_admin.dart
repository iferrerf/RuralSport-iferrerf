...
class _TP_detalle_pistas_adminState extends State<TP_detalle_pistas_admin> {
  ...
  Widget build(BuildContext context) {
    final String nombre = widget.pistaInfo['nombre'] ?? '';
    final String lugar = widget.pistaInfo['lugar'] ?? '';
    final String horario = widget.pistaInfo['horario'] ?? '';
    final String temporada = widget.pistaInfo['temporada'] ?? '';
    final List<dynamic> images = widget.pistaInfo['images'] ?? [];
    final String anoConstruccion = widget.pistaInfo['añoConstruccion'] ?? '';
    final String estado = widget.pistaInfo['estado'] ?? '';
